...
namespace Elinkcms\ElinkLaravelFileManager\Services\ConfigService;

/**
 * Class DefaultConfigRepository
 *
 * @package Elinkcms\ElinkLaravelFileManager\Services\ConfigService
 */
class DefaultConfigRepository implements ConfigRepository
{
    ...
    {
        return false; //config('file-manager.hiddenFiles');
    }
