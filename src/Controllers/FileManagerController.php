...
namespace Elinkcms\ElinkLaravelFileManager\Controllers;

use Elinkcms\ElinkLaravelFileManager\Events\BeforeInitialization;
use Elinkcms\ElinkLaravelFileManager\Events\Deleting;
use Elinkcms\ElinkLaravelFileManager\Events\DirectoryCreated;
use Elinkcms\ElinkLaravelFileManager\Events\DirectoryCreating;
use Elinkcms\ElinkLaravelFileManager\Events\DiskSelected;
use Elinkcms\ElinkLaravelFileManager\Events\Download;
use Elinkcms\ElinkLaravelFileManager\Events\FileCreated;
use Elinkcms\ElinkLaravelFileManager\Events\FileCreating;
use Elinkcms\ElinkLaravelFileManager\Events\FilesUploaded;
use Elinkcms\ElinkLaravelFileManager\Events\FilesUploading;
use Elinkcms\ElinkLaravelFileManager\Events\FileUpdate;
use Elinkcms\ElinkLaravelFileManager\Events\Paste;
use Elinkcms\ElinkLaravelFileManager\Events\Rename;
use Elinkcms\ElinkLaravelFileManager\Events\Zip as ZipEvent;
use Elinkcms\ElinkLaravelFileManager\Events\Unzip as UnzipEvent;
use Elinkcms\ElinkLaravelFileManager\Requests\RequestValidator;
use Elinkcms\ElinkLaravelFileManager\FileManager;
use Elinkcms\ElinkLaravelFileManager\Services\Zip;
...
class FileManagerController extends Controller
{
    ...
    public function unzip(RequestValidator $request, Zip $zip)
    {
        ...
        event(new AfterUnzipEvent($request));
